...
//  Selfiegram New
//
//  Created by michael massoud on 2016-09-06.
...
//        let urlString: String = "https://www.flickr.com/services/rest/?method=flickr.photos.search&format=json&nojsoncallback=1&api_key=2a5fd21d2ccaf9e104f0f39eb928b636 &tags=cat"
//        
//        let urlString = "https://www.flickr.com/services/rest/?method=flickr.photos.search&format=json&nojsoncallback=1&api_key=2a5fd21d2ccaf9e104f0f39eb928b636&tags=cat"
//        let url: NSURL = NSURL(string: urlString)!
//        
//        print("\(url)")
        
        let task = NSURLSession.sharedSession().dataTaskWithURL(NSURL(string: "https://www.flickr.com/services/rest/?method=flickr.photos.search&format=json&nojsoncallback=1&api_key=2a5fd21d2ccaf9e104f0f39eb928b636&tags=cat")!) { (data, response, error) -> Void in
...
//        cell.usernameLabel.text = post.user.userName
    ...
    //    cell.textLabel?.text = "This is a Post"
